$(document).ready(function () {
  ...
  $( '#button' ).on("click", function(event) {
    ...
    var $issueNumberDisplay = $('<div><span class="issueNumber text-muted">Issue ID:&nbsp;&nbsp; + 'stringGen()'</span></div>');
    ...
    $('.result-container').append( '$issueNumberDisplay' );  // Le numéro d'issue est attribué et s'affiche + le bouton
